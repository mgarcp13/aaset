...
LLVM_GCC="llvm-gcc -c -emit-llvm -I $SRC_INCLUDE_DIR -I $INCLUDE_DIR"
...
run_klee_execution () {
  klee --entry-point=_ada_$main_module --external-calls=all --output-dir=$OUTPUT_KLEE_DIR --link-llvm-lib=$LIB_INCLUDE_DIR/$external_libs $LIB_MAIN_DIR/$main_module.bc
}
