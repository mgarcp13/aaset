...
def make_param_symbolic (param_name):
    symbolic_param=ident+param_name+"_NAME : constant STRING := \""+param_name+"\"\n"
    symbolic_param+=ident+"make_symbolic("+param_name+"'ADDRESS,"+param_name+"'size / 8"+param_name+"_NAME'ADDRESS);"
    return symbolic_param
